...
urlpatterns = [
    ...
    re_path(r'^ai_suggest_tags/(?P<qset_id>[0-9]+)/$', ai_suggest_tags),
    ...
    re_path(r'^pending_sets/$', pending_sets),
    re_path(r'^suggestion_quality/$', suggestion_quality),
    ...
    re_path(r'^import_category_tags/(?P<qset_id>[0-9]+)/$', import_category_tags),
    ...
    re_path(r'^suggest_edit/$', suggest_edit),
    re_path(r'^resolve_suggestion/$', resolve_suggestion),
    re_path(r'^resolve_all_suggestions/$', resolve_all_suggestions),
